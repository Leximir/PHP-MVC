...
class Request
{
    ...
    public function getBody()
    {
        ...
        if ($this->method() === "get") { // Ako je metoda GET, uzimamo parametre iz query string-a ($_GET).
        ...
        if ($this->method() === "post") { // Ako je metoda POST, uzimamo podatke poslane kroz formu ($_POST).
